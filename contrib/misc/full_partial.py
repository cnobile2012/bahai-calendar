...
class DateTests(BahaiCalendar):
    ...
    TMP_ANS_DATES = (
        ...
        (2298587.5, (-262, 1, 1)), # (1581, 3, 11) -12
        (2298952.5, (-261, 1, 1)), # (1582, 3, 11) -12
        (2299317.5, (-260, 1, 1)), # (1583, 3, 21) -2
        ...
        (2415099.5, (  57, 1, 1)), # (1900, 3, 21) +1
        (2415464.5, (  58, 1, 1)), # (1901, 3, 21) +1
        (2415829.5, (  59, 1, 1)), # (1902, 3, 21) +1
        (2416195.5, (  60, 1, 1)), # (1903, 3, 22) +1
        (2416560.5, (  61, 1, 1)), # (1904, 3, 21) +1
        ...
        (2488513.5, ( 258, 1, 1)), # (2101, 3, 21) +2
        (2488878.5, ( 259, 1, 1)), # (2102, 3, 21) +2
        (2489243.5, ( 260, 1, 1)), # (2103, 3, 21) +2
        ...
        (2525037.5, ( 358, 1, 1)), # (2201, 3, 21) +3
        (2525402.5, ( 359, 1, 1)), # (2202, 3, 21) +3
        (2525767.5, ( 360, 1, 1)), # (2203, 3, 21) +3
        (2526133.5, ( 361, 1, 1)), # (2204, 3, 21) +3
        ...
        (2559370.5, ( 452, 1, 1)), # (2295, 3, 21) +3
        (2559735.5, ( 453, 1, 1)), # (2296, 3, 20) +3
        (2560100.5, ( 454, 1, 1)), # (2297, 3, 20) +3
        (2560465.5, ( 455, 1, 1)), # (2298, 3, 20) +3
        (2560831.5, ( 456, 1, 1)), # (2299, 3, 21) +3
        (2561196.5, ( 457, 1, 1)), # (2300, 3, 21) +4
        (2561561.5, ( 458, 1, 1)), # (2301, 3, 21) +4
        (2561926.5, ( 459, 1, 1)), # (2302, 3, 21) +4
        (2562291.5, ( 460, 1, 1)), # (2303, 3, 21) +4
        (2562657.5, ( 461, 1, 1)), # (2304, 3, 21) +4
        ...
        (2634975.5, ( 659, 1, 1)), # (2502, 3, 21) +5
        (2635340.5, ( 660, 1, 1)), # (2503, 3, 21) +5
        ...
        (2671134.5, ( 758, 1, 1)), # (2601, 3, 21) +6
        (2671499.5, ( 759, 1, 1)), # (2602, 3, 21) +6
        (2671864.5, ( 760, 1, 1)), # (2603, 3, 21) +6
        ...
        (2707293.5, ( 857, 1, 1)), # (2700, 3, 21) +7
        (2707658.5, ( 858, 1, 1)), # (2701, 3, 21) +7
        (2708023.5, ( 859, 1, 1)), # (2702, 3, 21) +7
        (2708388.5, ( 860, 1, 1)), # (2703, 3, 21) +7
        (2708754.5, ( 861, 1, 1)), # (2704, 3, 21) +7
        ...
        (2778880.5, (1053, 1, 1)), # (2896, 3, 19) +7
        (2779245.5, (1054, 1, 1)), # (2897, 3, 19) +7
        (2779611.5, (1055, 1, 1)), # (2898, 3, 20) +7
        (2779976.5, (1056, 1, 1)), # (2899, 3, 20) +7
        (2780341.5, (1057, 1, 1)), # (2900, 3, 20) +8
        (2780707.5, (1058, 1, 1)), # (2901, 3, 21) +8
        (2781072.5, (1059, 1, 1)), # (2902, 3, 21) +8
        (2781437.5, (1060, 1, 1)), # (2903, 3, 21) +8
...
if __name__ == "__main__":
    ...
    if options.analize:
        ...
        pprint.pprint(data)
        print(len([item[-1] for item in data if item[-1] != 0.0]))
