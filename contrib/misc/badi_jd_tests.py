...
class DateTests(BahaiCalendar):
    ...
    VE_0001_1582 = (
        ...
        ( 643, 3, 21,  5, 46), ( 644, 3, 20, 11, 35), ( 345, 3, 20, 17, 24),
    ...
    def _get_coff(self, year):
        ...
        p1 = ((-1783, -1750), (-1650, -1615), (-1499, -1483), (-1383, -1347),
              (-1251, -1215), (-1099, -1083), (-983, -947), (-299, -283),
              (-179, -143), (-47, -12), (101, 116), (213, 249), (345, 364),
              (365, 381), (501, 513), (609, 645), (741, 777), (901, 909),
              (1005, 1041), (1137, 1162))
        p1001 = ((-1698, -1682),)
        p1100 = ((-1299, -1283), (-899, -883), (-99, -95), (-91, -79),
                 (301, 313), (605, 609), (701, 709), (1101, 1105))
        p1101 = ((-1682, -1650),)
        p1110 = ((-1799, -1783), (-1399, -1383), (-1283, -1251), (-999, -983),
                 (-883, -851), (-199, -179), (-79, -47), (201, 213),
                 (313, 345), (601, 605), (709, 741), (1001, 1005), (1105, 1137))
        p1112 = ((-1750, -1714),)
        p1211 = ((116, 128),)
        p2 = ((-1519, -1499), (-1119, -1099), (-319, -299), (85, 101),
              (477, 501), (873, 901))
        p2111 = ((-1702, -1698), (-1615, -1583), (-1483, -1451),
                 (-1347, -1315), (-1327, -1315 ), (-1215,-1183 ),
                 (-1083, -1051), (-947, -915), (-283, -243), (-143, -111),
        ...
        p2211 = ((-1583, -1551), (-1451, -1435), (-1435, -1415),
                 ...
                 (1073, 1101))
        p2212 = ((-1814, -1802),)
        p2221 = ((-1803, -1799), (-1551, -1519), (-1415, -1399),
                 (-1151, -1119), (-1019, -999), (-211, -199), (53, 85),
