...
class DateTests(BahaiCalendar):
    ...
    def _get_jd_coeff(self, year):
        ...
        N1 = ((-1783, -1747), (-1651, -1615), (-1499, -1483), (-1383, -1347),
              ...
              (1137, 1162), )
        N1100 = ((-1699, -1683), (-1299, -1283), (-899, -883), (-499, -483),
                 (-99, -79), (301, 313), (701, 709), (1101, 1105), )
        N1110 = ((-1799, -1783), (-1683, -1651), (-1399, -1383),
                 (-1283, -1251), (-999, -983), (-883, -851), (-599, -583),
                 (-483, -451), (-199, -179), (-79, -47), (201, 213),
                 (313, 345), (601, 609), (709, 741), (1001, 1005),
                 (1105, 1137), )
        N2 = ((-1519, -1499), (-1119, -1099), (-719, -699), (-319, -299),
              (85, 101), (477, 501), (873, 901), )
        N2111 = ((-1747, -1715), (-1615, -1583), (-1483, -1451),
                 ...
                 (1041, 1073), )
        N2211 = ((-1842, -1815), (-1715, -1699), (-1583, -1551),
        ...
        N2221 = ((-1815, -1799), (-1551, -1519), (-1415, -1399),
        ...
        if not coeff:
            coeff = process_segments(year, N1, -1, (0, 1, 2, 3))

        if not coeff:
            coeff = process_segments(year, N1100, -1, (0, 3))

        if not coeff:
            coeff = process_segments(year, N1110, -1, (0, 2, 3))

        if not coeff:
            coeff = process_segments(year, N2, -2, (0, 1, 2, 3))

        if not coeff:
            coeff = process_segments(year, N2111, -2, (0,), -1, (1, 2, 3))

        if not coeff:
            coeff = process_segments(year, N2211, -2, (0, 3), -1, (1, 2))

        if not coeff:
            coeff = process_segments(year, N2221, -2, (0, 2, 3), -1, (1,))
