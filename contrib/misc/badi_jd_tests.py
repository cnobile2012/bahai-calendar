...
class DateTests(BahaiCalendar):
    ...
    def _get_jd_coeff(self, year):
        ...
        P1 = ((-1781, -1747), (-1651, -1615), (-1499, -1483), (-1383, -1347),
        ...
        P1110 = ((-1683, -1651), (-1399, -1383), (-1283, -1251), (-999, -983),
                 (-883, -851), (-599, -583), (-483, -451), (-199, -179),
                 (-79, -47), (201, 213), (313, 345), (601, 609), (709, 741),
                 (1001, 1005), (1105, 1137), )
        P1122 = ((-1841, -1813), )
        P2 = ((-1842, -1841), (-1519, -1499), (-1119, -1099), (-719, -699),
              (-319, -299), (85, 101), (477, 501), (873, 901))
        P2111 = ((-1801, -1797), (-1747, -1715), (-1615, -1583),
                 (-1483, -1451), (-1347, -1315), (-1215, -1183),
        ...
        P2122 = ((-1813, -1801), )
        P2211 = ((-1715, -1699), (-1583, -1551), (-1451, -1415),
                 ...
                 (1073, 1101))
        P2221 = ((-1551, -1519), (-1415, -1399), (-1151, -1119), (-1019, -999),
                 (-751, -719), (-619, -599), (-351, -319), (-211, -199),
        ...
        if not coeff:
            coeff = process_segments(year, P2122, -2, (0, 1, 2), -1, (3,))
