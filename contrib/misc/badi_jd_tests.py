...
class DateTests(BahaiCalendar):
    ...
    def _get_coff(self, year):
        ...
        p0100 = ((-95, -91),)
        p1 = ((-1783, -1750), (-1650, -1615), (-1499, -1483), (-299, -283),
              (-179, -143), (-47, -12), (101, 116), (213, 249), (345, 364),
              (365, 381), (501, 513), (609, 645), (741, 777), (901, 909),
              (1005, 1041), (1137, 1162))
        p1001 = ((-1698, -1682),)
        ...
        p2111 = ((-1702, -1698), (-1615, -1583), (-1483, -1451), (-283, -243),
                 (-143, -111), (-11, 21), (117, 125), (129, 149), (249, 281),
                 (381, 413), (513, 545), (645, 677), (777, 809), (909, 941),
                 (1041, 1073))
        p2112 = ((-1842, -1814), (-1714, -1702))
        p2211 = ((-1583, -1551), (-1451, -1435), (-243, -211), (-111, -99),
