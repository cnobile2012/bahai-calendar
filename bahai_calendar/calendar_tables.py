# -*- coding: utf-8 -*-
#
# bahai_calendar/calendar_tables.py
#
...
class CalendarTables:
    ...
    L0_B = (0, 4.6692568, 4.6261, 2.7441, 2.8289, 3.6277, 4.4181, 6.1352,
            0.7425, 2.0371, 1.1096, 5.233, 2.045, 3.508, 1.179, 2.533, 4.583,
            4.205, 2.92, 5.849, 1.899, 0.315, 0.345, 4.806, 1.869, 2.548,
    ...
    L0_C = (0, 6283.07585, 12566.15171, 5753.3849, 35231, 77713.7715,
            ...
            8429.24, 19651.05, 10447.37, 10213.29, 1059.38, 2352.87, 6812.77,
            17789.85, 83996.85, 1349.87, 4690.48)
    L1_A = (628331966747, 206059, 4303, 425, 119, 109, 93, 72, 68, 67, 59,
            56, 45, 36, 29, 21, 19, 19, 17, 16, 16, 15, 12, 12, 12, 12, 11,
            10, 10, 9, 9, 8, 6, 6)
    L1_B = (0, 2.678235, 2.6351, 1.59, 5.796, 2.966, 2.59, 1.14, 1.87, 4.41,
            2.89, 2017, 0.4, 0.47, 2.65, 5.34, 1.85, 4.97, 2.99, 0.03, 1.43,
            1.21, 2.83, 3.26, 5.27, 2.08, 0.77, 1.3, 4.24, 2.7, 5.64, 5.3,
            2.65, 4.67)
    L1_C = (0, 3283.07585, 1256.1517, 3.523, 26.298, 1577.344, 18849.23,
            529.69, 398.15, 5507.55, 5223.39, 155.42, 796.3, 775.52, 7.11,
    ...
    L2_A = (52919, 8720, 309, 27, 16, 16, 10, 9, 7, 5, 4, 4, 3, 3, 3, 3, 3,
            3, 2, 2)
    L2_B = (0, 1.0721, 0.867, 0.05, 5.19, 3.68, 0.76, 2.05, 0.83, 4.66, 1.03,
            3.44, 5.14, 6.05, 1.19, 6.12, 0.31, 2.28, 4.38, 3.75)
    L2_C = (0, 6283.0758, 12566.152, 3.52, 26.3, 155.42, 18849.23, 77713.77,
            775.52, 1577.35, 7.11, 5573.14, 796.3, 5507.55, 242.73, 529.69,
    ...
    L4_A = (114, 8, 1)
    L4_B = (3.142, 4.13, 3.87)
    L4_C = (0, 6283.08, 12366.15)
    L5_A = (1,)
    L5_B = (3.14,)
    L5_C = (0,)
    ...
    B0_B = (3.199, 5.422, 3.88, 3.70, 4.0)
    ...
    # The radius vector R
    R0_A = (1000013989, 1670700, 13956, 3084, 1628, 1576, 925, 542, 472, 346,
    ...
    R0_B = (0, 30984635, 3.05525, 5.1985, 1.1739, 2.8469, 5.453, 4.564,
            ...
            4.59)
    R0_C = (0, 6283.07585, 12566.1517, 77713.7715, 5753.3849, 7860.4194,
    ...
    R1_B = (1.107490, 1.0644, 3.142, 1.02, 2.84, 1.32, 1.42, 5.91, 1.42, 0.27)
    ...
    R2_C = (6283.0758, 12566.152, 0, 77713.77, 5573.14, 18849.23)
    R3_A = (145, 5)
    R3_B = (4.273, 3.92)
