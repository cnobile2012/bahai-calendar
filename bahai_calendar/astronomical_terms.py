...
class AstronomicalTerms:
    ...
    L0_C = (0, 6283.07585, 12566.1517, 5753.3849, 3.5231, 77713.7715,
    ...
    L1_B = (0, 2.678235, 2.6351, 1.59, 5.796, 2.966, 2.59, 1.14, 1.87, 4.41,
            ...
            2.65, 4.67)
    L1_C = (0, 6283.07585, 12566.1517, 3.523, 26.298, 1577.344, 18849.23,
    ...
    L2_A = (52919, 8720, 309, 27, 16, 16, 10, 9, 7, 5, 4, 4, 3, 3, 3, 3, 3,
            3, 2, 2)
    L2_B = (0, 1.0721, 0.867, 0.05, 5.19, 3.68, 0.76, 2.06, 0.83, 4.66, 1.03,
    ...
    # The radius vector R
    R0_A = (100013989, 1670700, 13956, 3084, 1628, 1576, 925, 542, 472, 346,
            329, 307, 243, 212, 186, 175, 110, 98, 86, 86, 65, 63, 57, 56,
            49, 47, 45, 43, 39, 38, 37, 37, 36, 35, 33, 32, 32, 28, 28, 26)
    R0_B = (0, 3.0984635, 3.05525, 5.1985, 1.1739, 2.8469, 5.453, 4.564,
    ...
    EQ_SO_A = (485, 203, 199, 182, 156, 136, 77, 74, 70, 58, 52, 50, 45,
               44, 29, 18, 17, 16, 14, 12, 12, 12, 9, 8)
    EQ_SO_B = (324.96, 337.23, 342.08, 27.85, 73.14, 171.52, 222.54, 296.72,
               243.58, 119.81, 297.17, 21.02, 247.54, 325.15, 60.93, 155.12,
               288.79, 198.04, 199.76, 95.39, 287.11, 320.81, 227.73, 15.45)
    EQ_SO_C = (1934.136, 32964.467, 20.186, 445267.112, 45036.886, 22518.443,
