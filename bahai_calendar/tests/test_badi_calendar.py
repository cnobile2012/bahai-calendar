...
class TestBadiCalendar(unittest.TestCase):
    ...
    def test_badi_date_from_jd(self):
        ...
        data = (
            ...
            (2299316.258627, True, (-260, 1, 1)), # 1583-03-21T18:14:00
            # 1st day of Ayyám-i-Há
            (2459634.243336, True, (178, 0, 1)),  # 2022-02-25T17:52:00
            (2459638.246044, True, (178, 0, 5)),  # 2022-03-01T17:56:00
            (2459638.246044, True, (178, 19, 1)), # 2022-03-02T17:57:00

            # 2024-05-14T19:02:00 -> Badi short form
            (2460443.293056, True, (181, 3, 18)),
            # 2024-05-14T19:02:00 -> Badi long form
            (2460443.293056, False, (1, 10, 10, 3, 18)),
            )
