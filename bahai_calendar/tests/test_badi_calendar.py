...
class TestBadiCalendar(unittest.TestCase):
    ...
    def test_jd_from_badi_date(self):
        ...
        data = (
            ...
            ((-260, 1, 1, 18, 16), 2299318.54196), # 1583-03-21T18:16:00
    ...
    def test_badi_date_from_jd(self):
        ...
        data = (
            # 0001-03-20T18:13:00
            (1721502.258473, True, (-1842, 1, 1)),
            # 0001-04-08T18:24:00
            (1721520.26872, True, (-1842, 1, 19, 18, 26, 57.408004)),
            # 0001-
            (1721849.248592, True, (-1842, 19, 1, 17, 57, 58.348799)),
            # 0001-
            (1721853.250972, True, (-1842, 19, 5, 18, 1, 23.980796)),
            # 1583-03-21T18:11:33.5328
            (2299316.258027, True, (-260, 1, 1, 18, 11, 33.53279)),
            # 1844-03-20T18:12:2.3904
            (2394644.258361, True, (1, 1, 1, 18, 12, 2.390409)),
            # 1863-03-21T18:11:29.7312
            (2401584.257983, True, (20, 1, 1, 18, 11, 29.731202)),
            # 2024-03-20T18:12:2.3904
            (2460388.258491, True, (181, 1, 1, 18, 12, 13.622414)),
            # 2024-04-20T18:39:5.1552
            (2460419.277143, True, (181, 2, 13, 18, 39, 5.155214)),
            # 1st day of Ayyám-i-Há -> 2022-02-25T17:50:24.2304
            (2459634.243336, True, (178, 0, 1, 17, 50, 24.230401)),
            # 2022-03-01T17:54:18.2016
            (2459638.246044, True, (178, 0, 5, 17, 54, 18.201613)),
            # 2022-03-02T17:55:15.9168
            (2459639.246712, True, (178, 19, 1, 17, 55, 15.916809)),
            # Badi short form -> 2024-05-14T18:59:54.3264
            (2460443.291601, True, (181, 3, 18, 18, 59, 54.32639)),
            # Badi long form -> 2024-05-14T18:59:54.3264
            (2460443.291601, False, (1, 10, 10, 3, 18, 18, 59, 54.32639)),
            )
