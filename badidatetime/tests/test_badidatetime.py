...
class TestBadiDatetimeFunctions(unittest.TestCase):
    ...
    def test__isoweek_to_badi(self):
        ...
        data = (
            ((-1842, 1, 1), False, False, (-5, 18, 1, 1, 4, 23, 57, 38.6496)),
            ((-1842, 1, 1), True, False, (-1842, 1, 4, 23, 57, 38.6496)),
            ((181, 1, 1), True, False, (181, 1, 3, 23, 54, 56.3904)),
            ((182, 1, 1), True, False, (182, 1, 2, 23, 56, 1.104)),
            ((183, 1, 1), True, False, (183, 1, 1)),
            ((181, 1, 7), True, False, (181, 1, 9, 23, 49, 44.9184)),
            ((181, 20, 7), True, False, (181, 8, 9, 23, 13, 57.1008)),
