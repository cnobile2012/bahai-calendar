...
class TestTimeDateUtils(unittest.TestCase):
    ...
    def test_strftime(self):
        ...
        data = (
            ...
            ('%f', (1, 10, 10, 1, 1, 0, 0, 60.025), -1, ttup_l, '025000'),
    ...
    def test__isoweek_to_badi(self):
        ...
        data = (
            ...
            ((  181,  1,  7), True,  False, (181, 1, 3)),
            ((  181, 20,  7), True,  False, (181, 8, 3)),
    ...
    def test__parse_isoformat_date_time_timezone(self):
        ...
        data = (
            ...
            ('0181-W20T12:00:00', (181, 7, 16, 12, 0, 0), 'None'),
            ('0181-W20-5T12:00:00', (181, 8, 1, 12, 0, 0), 'None'),
    ...
    def test__parse_isoformat_date(self):
        ...
        data = (
            ...
            ('0181W017', False, (181, 1, 3)),
            ('0181-W01-7', False, (181, 1, 3)),
            ('0181W207', False, (181, 8, 3)),
