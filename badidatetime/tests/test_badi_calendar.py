...
class TestBadiCalendar(unittest.TestCase):
    ...
    def test_utc_sunset(self):
        ...
        data = (
            ...
            ((1, 1, 1), epoch_coords, (18, 16, 28.0164)),
            ((1, 1, 1), (None, None, None), (18, 16, 28.0164)),
            # Should be 2024-03-19T18:13:00
            ((180, 19, 19), epoch_coords, (18, 15, 48.0384)),
            # Should be 2064-03-19T18:16:00
            ((221, 1, 1), epoch_coords, (18, 16, 52.4892)),
    ...
    def test_naw_ruz_g_date(self):
        ...
        data = (
            ...
            (1, epoch_coords, False, True, (1844, 3, 19.761435381137)),
            # 1844-03-19T18:16:00+03:30
            (1, epoch_coords, True, True, (1844, 3, 19, 18, 16, 28.0164)),
            # 2024-03-19T18:26:00-05:00
            (181, local_coords, True, True, (2024, 3, 19, 18, 25, 57.5004)),
            # 2025-03-19T18:16:00+03:30
            (182, epoch_coords, False, True, (2025, 3, 19.761417605449)),
            # 2026-03-20T18:16:00+03:30
            (183, epoch_coords, False, True, (2026, 3, 20.761861174833)),
            # The following years are the ones that had errors.
            # 2021-03-19T18:16:00+03:30
            (178, epoch_coords, False, True, (2021, 3, 19.761398029048)),
            # 2030-03-20T18:16:00:+03:30
            (187, epoch_coords, False, True, (2030, 3, 19.761294165626)),
            # 2034-03-19T18:16:00+03:30
            (191, epoch_coords, False, True, (2034, 3, 19.761306300759)),
            # 2038-03-19T18:16:00+03:30
            (195, epoch_coords, False, True, (2038, 3, 19.761318070348)),
            # 2054-03-19T18:16:00+03:30
            (211, epoch_coords, False, True, (2054, 3, 19.761382790748)),
            # 2059-03-20T18:16:21.590400
            (216, epoch_coords, False, True, (2059, 3, 19.761253836565)),
            # 2063-03-19T18:16:23.318400
            (220, epoch_coords, False, True, (2063, 3, 19.761274053715)),
            # Test default latitude, longitude, and zone.
            (1, epoch_coords, False, False, (1844, 3, 19.761435381137)),
            # 1993-03-19T18:16:24.960000 Test sunset before Vernal Equinox
            (150, epoch_coords, False, True, (1993, 3, 19.761295336764)),
            )
    ...
    def test_first_day_of_ridvan_g_date(self):
        ...
        data = (
            ...
            (1, epoch_coords, False, True, (1844, 4, 19.779124132358)),
            (1, epoch_coords, True, True, (1844, 4, 19, 18, 41, 56.3244)),
            ...
            # Test default latitude, longitude, and zone.
            (1, epoch_coords, False, False, (1844, 4, 19.779124132358)),
            )
    ...
    def test_gregorian_date_from_badi_date(self):
        ...
        data = (
            ...
            ((1, 1, 1), epoch_coords, True, False,
             (1844, 3, 17, 18, 16, 28, 16400)),
            ((181, 3, 18, 20), epoch_coords, True, False,
             (2024, 5, 12, 15, 2, 22, 941600)),
            )
    ...
    def test_timestamp_from_badi_date(self):
        ...
        data = (
            ...
            # Badi POSIX epoch date.
            ((126, 16, 2, 7, 59, 32.4924), gmt_coords, 0.000362098217),
            # 1970:01:01T00:00:00Z -> 1969-12-31T20:30:00+03:30
            # Sunset day before = 17:01 -> 24:00 - 17:01 = 06:59 ->
            # 06:59 + 00:00 = 06:59 -> -25200
            ((126, 16, 2, 4, 29, 32.4924), epoch_coords, -21511.613354086876),
            # 1970-01-01T00:00:00Z -> 1970-01-01T03:30:00+03:30
            # Sunset day before = 17:01 -> 24:00 - 17:01 = 06:59 ->
            # 06:59 + 03:30 = 10:29 -> approximately -12600
            ((126, 16, 2, 11, 29, 32.4924), epoch_coords, 3688.386632502079),
            # 1970-01-01T00:00:00Z -> 1969-12-31T19:00:00-05:00
            # Sunset day before = 17:12 -> 19:00 - 17:12 = 01:48 ->
            # approximately 18000
            ((126, 16, 2, 7, 59, 32.4924), local_coords, 22295.35000026226),
            )
    ...
    def test__utc_to_badi_time(self):
        ...
        data = (
            ...
            # 2440585.4368055555
            (self._bc._POSIX_EPOCH, epoch_coords, (2440585.0638413684,
                                                   0.4361586314626038)),
            # _POSIX_EPOCH = 2440585.5 -> 1970-01-01T00:00:00Z ->
            ...
            # 2461118.1404293982
            (2461120.261263, epoch_coords, (2461120.1171926064,
                                            0.1440703934058547)),
            ...
            (2394643.118056, epoch_coords, (2394643.1156020476,  # Above min
                                            0.0024539525620639324)),
            # 1844-03-19T14:42:00Z -> 1844-03-19T18:12:00+03:30 ->
            # Sunset day before = 18:15 -> 24:00 - 18:15 = 05:45 ->
            # 05:45 + 18:12 = 23:57 -> 2394642.9979166666
            (2394643.112500, epoch_coords, (2394642.1150211776,
                                            0.9974788222461939)),  # Below min
            # 1844-03-19T20:26:00Z -> 1844-03-19T23:56:00+03:30 ->
            # Sunset = 18:16 -> 23:56 - 18:16 = 05:40 -> 2394643.2361111111
            (2394643.351389, epoch_coords, (2394643.1156020476,  # Below max
                                            0.23578695254400373)),
            # 1844-03-19T20:34:00Z -> 1844-03-20T00:04:00+03:30 ->
            # Sunset day before = 18:16 -> 24:00 - 18:16 = 05:44 ->
            # 05:44 + 00:04 = 05:48 -> 2394642.24166666666
            (2394643.356944, epoch_coords, (2394643.1156020476,
                                            0.2413419522345066)),  # Above max
